...
// Buscamos el álbum con datos del artista
$id = $_GET['id'];
...
// Buscamos las canciones de este álbum
...
mysqli_stmt_close($stmt_canciones);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    <a href="albumes.php" class="volver-link">← Volver a álbumes</a>
    ...
    <div class="detalle-album">
        ...
        <div class="detalle-info">
            ...
            <div class="detalle-acciones">
                <a href="editar_album.php?id=<?php echo $album['id']; ?>" class="btn btn-pequeno">Editar álbum</a>
            </div>
        </div>
    ...
    <?php if ($total_canciones > 0): ?>
        ...
        <div class="lista-canciones">
            <?php 
            // Reiniciamos el puntero del resultado para recorrerlo
    ...
    <a href="agregar_cancion.php" class="btn" style="margin-top: 20px;">+ Agregar canción</a>
