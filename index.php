<?php
// Paso 1: Traemos la conexión
require 'conexion.php';

// Paso 2: Consultamos todos los artistas, ordenados por nombre
...
<body>
    ...
    <?php if (isset($_GET['mensaje'])): ?>
        ...
        <?php elseif ($_GET['mensaje'] === 'artista_tiene_albumes'): ?>
            <p class="mensaje-error">No se puede eliminar: este artista tiene álbumes asociados. Elimina sus álbumes primero.</p>
        <?php endif; ?>
    <?php endif; ?>

    <a href="agregar_artista.php" class="btn">+ Agregar nuevo artista</a>
            ...
            <tbody>
                <?php while ($artista = mysqli_fetch_assoc($resultado)): ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_artista.php?id=<?php echo $artista['id']; ?>">Editar</a>
                            |
                            <a href="eliminar_artista.php?id=<?php echo $artista['id']; ?>"
